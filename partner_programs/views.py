...
class PartnerProgramDetail(generics.RetrieveAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        current_project_application = None
        if is_user_member:
            current_project_application = get_current_project_application(
        ...
        data["current_project_application"] = current_project_application
        if request.user.is_authenticated:
