...
Публичного Team API пока нет. Следующий PR должен добавить Team permissions и
управление составом так, чтобы операции принятия участников использовали те же
cross-table проверки без изменения legacy-дедлайнов.
